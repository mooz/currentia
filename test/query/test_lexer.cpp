...
TEST (testLexer, comment) {
    ...
    EXPECT_EQ(TOKEN_SELECT, lexer.get_next_token());
    EXPECT_EQ(TOKEN_EOS, lexer.get_next_token());
}
...
TEST (testLexer, keywords) {
    ...
    EXPECT_EQ(TOKEN_SELECT, lexer.get_next_token());
    EXPECT_EQ(TOKEN_FROM, lexer.get_next_token());
    EXPECT_EQ(TOKEN_WHERE, lexer.get_next_token());
    EXPECT_EQ(TOKEN_EOS, lexer.get_next_token());
}
...
TEST (testLexer, name) {
    ...
    EXPECT_EQ(TOKEN_NAME, lexer.get_next_token());
...
TEST (testLexer, DDL) {
    ...
    EXPECT_EQ(TOKEN_CREATE, lexer.get_next_token());
    EXPECT_EQ(TOKEN_STREAM, lexer.get_next_token());

    EXPECT_EQ(TOKEN_NAME, lexer.get_next_token());
    EXPECT_EQ("members", lexer.get_token_text());

    EXPECT_EQ(TOKEN_LPAREN, lexer.get_next_token());
    ...
    EXPECT_EQ(TOKEN_COMMA, lexer.get_next_token());
    ...
    EXPECT_EQ(TOKEN_RPAREN, lexer.get_next_token());
...
TEST (testLexer, IN) {
    ...
    EXPECT_EQ(TOKEN_IN, lexer.get_next_token());
...
TEST (TestDDL, TABLE) {
    ...
    EXPECT_EQ(TOKEN_CREATE, lexer.get_next_token());
    EXPECT_EQ(TOKEN_TABLE, lexer.get_next_token());
