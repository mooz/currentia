...
TEST (testLexer, empty) {
    ...
    EXPECT_EQ(Lexer::TOKEN_EOS, lexer.next_token());
}
...
TEST (testLexer, comment) {
    ...
    EXPECT_EQ(Lexer::TOKEN_SELECT, lexer.next_token());
    EXPECT_EQ(Lexer::TOKEN_EOS, lexer.next_token());
}
...
TEST (testLexer, keywords) {
    ...
    EXPECT_EQ(Lexer::TOKEN_SELECT, lexer.next_token());
    EXPECT_EQ(Lexer::TOKEN_FROM, lexer.next_token());
    EXPECT_EQ(Lexer::TOKEN_WHERE, lexer.next_token());
    EXPECT_EQ(Lexer::TOKEN_EOS, lexer.next_token());
}
...
TEST (testLexer, name) {
    ...
    EXPECT_EQ(Lexer::TOKEN_NAME, lexer.next_token());
...
TEST (testLexer, DDL) {
    ...
    EXPECT_EQ(Lexer::TOKEN_CREATE, lexer.next_token());
    EXPECT_EQ(Lexer::TOKEN_STREAM, lexer.next_token());

    EXPECT_EQ(Lexer::TOKEN_NAME, lexer.next_token());
    EXPECT_EQ("MEMBERS", lexer.get_latest_name_string());

    EXPECT_EQ(Lexer::TOKEN_LPAREN, lexer.next_token());
    ...
    EXPECT_EQ(Lexer::TOKEN_COMMA, lexer.next_token());
    ...
    EXPECT_EQ(Lexer::TOKEN_RPAREN, lexer.next_token());
...
TEST (testLexer, IN) {
    ...
    EXPECT_EQ(Lexer::TOKEN_IN, lexer.next_token());
...
TEST (TestDDL, TABLE) {
    ...
    EXPECT_EQ(Lexer::TOKEN_CREATE, lexer.next_token());
    EXPECT_EQ(Lexer::TOKEN_TABLE, lexer.next_token());
